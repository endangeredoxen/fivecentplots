...
#########################################################
fcp_params = {'ax_edge_color': '#dbdbdb',
              'ax_edge_width': 1,
              ...
              'box_group_means_width': 1,
              'box_group_title_edge_color': '#ffffff',
              'box_group_title_fill_color': '#ffffff',
              'box_group_title_font_size': 11,
              'box_group_title_font_color': '#444444',
              'box_group_title_font_style': 'normal',
              'box_group_title_font_weight': 'bold',
              'box_group_label_edge_color': '#cccccc',
              'box_group_label_font_size': 11,
              'box_group_label_font_color': '#444444',
              ...
              'cbar_size': 30,
              'dpi': 100,
              'fig_edge_color': '#1e1e1e',
              'fig_fill_color': '#1e1e1e',
              ...
              'hist_rwidth': None,
              'label_fill_color': '#1e1e1e',
              'label_font_color': '#eeeeee',
              'label_font_size': 12,
              ...
              'label_rc_size': 30,
              'legend_fill_color': '#1e1e1e',
              'legend_edge_color': '#1e1e1e',
              'legend_font_color': '#eeeeee',
              'legend_font_size': 11,
              'legend_points': 1,
              'legend_title': '',
              'legend_title_font_color': '#eeeeee',
              ...
              'pie_shadow': False,
              'pie_start_angle': 90,
              'tick_labels_major_font_size': 11,
              'tick_labels_major_font_color': '#eeeeee',
              'tick_labels_minor_font_color': '#eeeeee',
              'ticks_major_color': '#ffffff',
              'ticks_minor_color': '#ffffff',
              'title_fill_color': '#1e1e1e',
              'title_edge_color': '#1e1e1e',
              'title_font_color': '#eeeeee',
              'title_font_size': 15,
              'title_font_weight': 'bold',
              'title_wrap_edge_color': '#5f5f5f',
              'title_wrap_fill_color': '#5f5f5f',
              'title_wrap_font_size': 13,

...
def bar(df, **kwargs):
    ...
    Keyword Args:
        ...
        bar_align|align (str): If ‘center’ aligns center of bar to x-axis value; if ‘edge’ aligns the left edge of the
            bar to the x-axis value. Defaults to ‘center’ .
        bar_color_by|color_by (str|None): Color each bar differently based on a grouping criterion. Defaults to 'bar'.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/barplot.html#Color-by-bar
        ...
        bar_error_bars|error_bars (bool): Display error bars on each bar. Defaults to False. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/barplot.html#Error-bars
        ...
        bar_horizontal|horizontal (bool): Display bars horizontally. Defaults to False. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/barplot.html#Horizontal-bars
        bar_rolling|bar_rolling_mean|rolling|rolling_mean (int): Rolling mean window size [enables this curve]. No
            default. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/barplot.html#Rolling-mean
        bar_stacked|stacked (bool): Stack bars of a given group . Defaults to False. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/barplot.html#Stacked
        ...
        rolling_mean_line_color (str): Hex color string for the rolling mean line. Defaults to fcp.DEFAULT_COLORS.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/barplot.html#Custom-line-style
        rolling_mean_line_width (int): Width for the rolling mean line in pixels. Defaults to 2. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/barplot.html#Custom-line-style
    Examples
    --------
        >>> import fivecentplots as fcp
        >>> from pathlib import Path
...
def boxplot(df, **kwargs):
    ...
    Keyword Args:
        ...
        box_divider (bool): Toggle box divider visibility. Defaults to True. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/boxplot.html#Dividers
        ...
        box_edge_color (str): Hex color string for the edge of the box. Defaults to #aaaaaa. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Boxplot-example
        ...
        box_range_lines (bool): Toggle the horizontal lines showing the min/max of the data range. Defaults to True.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/boxplot.html#Range-lines
        ...
        box_whisker (bool): Toggle range lines that extend from the box Q1/Q3 edges to the data min/max. Defaults to
            True. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/boxplot.html#Whiskers
        ...
        groups (str|list): Grouping columns for the box plot. Defaults to None. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/boxplot.html#Groups
        notch (bool): Use a notched-style box instead of a rectangular box. Defaults to False. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/boxplot.html#Notch
        GROUPING_TEXT:
        ...
        box_grand_mean (bool): Toggle visibility of a line showing the mean of all data on the plot. Defaults to False.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/boxplot.html#Grand-Mean/Median
        ...
        box_grand_median (bool): Toggle visibility of a line showing the median of all data on the plot. Defaults to
            False. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/boxplot.html#Grand-Mean/Median
        ...
        box_group_mean (bool): Toggle visibility of a line showing the mean of each data group on the plot. Defaults to
            False. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/boxplot.html#Group-Means
        ...
        box_stat_line (str): Set the statistic for the connecting line {‘mean’, ‘median’, ‘std’, ‘qXX’ [qunatile where
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/boxplot.html#Stat-line
        ...
        box_mean_diamonds_edge_style|mean_diamonds_edge_style (str): Line style for the diamonds lines {‘-’, ‘--’, ‘-.’,
            ‘:’}. Defaults to '-’.
        box_mean_diamonds_edge_width|mean_diamonds_edge_width (float): Width of the diamond lines in pixels. Defaults to
            0.7.
        ...
        box_mean_diamonds|mean_diamonds (bool): Toggle visibility of a diamond overlay on the box showing the group mean
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/boxplot.html#Mean-Diamonds
        ...
        box_violin|violin (bool): Toggle visibility of violin plot showing the distribution of box plot data. Defaults
            to False. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/boxplot.html#Violins
...
def contour(df, **kwargs):
    ...
    Keyword Args:
        ...
        cmap (str): Name of a color map . Defaults to inferno. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/contour.html#Filled-contour
        contour_width (float): Width of the contour lines. Defaults to 1. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/contour.html#Contour-lines
        ...
        interp (str): Scipy interpolate.griddata method to make Z points {‘linear’, ‘nearest’, ‘cubic’}. Defaults to
            'cubic’. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/contour.html#Data-interpolation
        ...
        show_points (bool): Show points on top of the contour plot. Defaults to False. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/contour.html#Contour-points
        COLOR_BAR:
...
def gantt(df, **kwargs):
    ...
    Keyword Args:
        ...
        y (str): y-axis column name
        BASIC:
        gantt_auto_expand|auto_expand (bool): Auto-expand the horizontal axes size to fit the Gantt bar labels. Defaults
            to True. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/gantt.html#Bar-labels
        gantt_bar_labels|bar_labels (bool): Display data column labels to the right of Gantt bars. Defaults to False.
            Example: gantt.#Bar-labels
        gantt_color_by|color_by (str|None): Color each bar differently based on a grouping criterion. Defaults to 'bar'.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/gantt.html#Styling
        ...
        gantt_edge_width (float): Width of the edge of the Gantt bars in pixels. Defaults to 0. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/gantt.html#Styling
        ...
        gantt_height|bar_height (float): Set the fractional height of the Gantt bars between 0-1. Defaults to 0.9.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/gantt.html#Styling
        ...
        gantt_tick_labels_x_rotation|tick_labels_x_rotation (int): Gantt-specific version of the this kwarg to ensure
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/gantt.html#Legends
        sort (str): Sort order for the Gantt bars {‘ascending’, ‘descending’}. Defaults to 'descending’. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/gantt.html#Sorting
        us_holidays (bool): Skip US holidays based on the Federal calendar. Defaults to True. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/gantt.html#US-holidays
    Examples
    --------
        >>> import fivecentplots as fcp
        >>> from pathlib import Path
...
def heatmap(df, **kwargs):
    ...
    Keyword Args:
        ...
        cell_size (int): Width of a heatmap cell in pixels. Defaults to 60. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/heatmap.html#Cell-size
        cmap (bool): Name of a color map to apply to the plot. Defaults to inferno. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/heatmap.html#No-data-labels
        data_labels (bool): Toggle visibility of value text labels on the heatmap cells. Defaults to False. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/heatmap.html#With-data-labels
        ...
        heatmap_interp|interp (str): imshow interpolation scheme [see matplotlib docs for more details]. Defaults to
            'none’.
        heatmap_rounding (int): Number of digits to round heatmap data labels. Defaults to None. Example: 3
        COLOR_BAR:
        cbar (bool): Toggle colorbar on/off for contour and heatmap plots. Defaults to False. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/contour.html#Filled-contour
        size (int): cbar width [height will match the height of the axes]. Defaults to 30.
...
def hist(df, **kwargs):
    ...
    Keyword Args:
        ...
        BASIC:
        bars (bool): Toggle between bars or a line plot for the counts (True=bars enabled, False=use line). Defaults to
            True unless 2D image then False.
        cdf (bool): Convert the histogram into a cumulative distribution plot. Defaults to False. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/hist.html#cdf
        cfa (str): Color-filter array pattern that is used to split data from a Bayer image into separate color planes.
            Defaults to None. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/imshow.html#split-color-
            planes
        hist_align (str): If "mid" aligns center of histogram bar to x-axis value; if "left" aligns the left edge of the
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/hist.html#alignment
        hist_bins|bins (int): Number of histogram bins to use; when plotting the histogram of a raw image file the
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/hist.html#bin-counts
        hist_cumulative|cumulative (bool): From matplotlib: If True then a histogram is computed where each bin gives
            the counts in that bin plus all bins for smaller values; if -1 direction of accumulation is reversed.
            Defaults to False. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/hist.html#cumulative
        hist_edge_color (str): Hex color string for the edge of the histogram bar. Defaults to fcp.DEFAULT_COLORS.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/hist.html#colors
        hist_edge_width (float): Width of the edge of the histogram bar in pixels. Defaults to 0. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/hist.html#colors
        ...
        hist_horizontal|horizontal (bool): Enable a horizontal histogram plot [default is vertical]. Defaults to False.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/hist.html#horizontal-bars
        hist_kde|kde (bool): Toggle visibility of a kernel-density estimator curve over the histogram bars. Defaults to
            False. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/hist.html#kernel-density-estimator
        hist_normalize|normalize (bool): Sets the "density" parameter for matplotlib-based plots; from matplotlib: if
            ...
            number of counts and the bin width so that the area under the histogram integrates to 1; automatically
            enabled if kde=True. Defaults to False. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/hist.html#cumulative
        hist_rwidth (float|None): From matplotlib: the relative width of the bars as a fraction of the bin width; None
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/hist.html#width
        pdf (bool): Convert the histogram into a probability density function plot. Defaults to False. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/hist.html#pdf
    Examples
    --------
    Simple histogram:
...
def imshow(df: Union[pd.DataFrame, npt.NDArray], **kwargs):
    ...
    Keyword Args:
        ...
        cmap (bool): Name of a color map to apply to the plot. Defaults to gray. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/imshow.html#color-maps
        ...
        stretch (float|list): Calculate "stretch" times the standard deviation above and below the mean to set new
            z-limits. Can be a single value used as +/- limits or a two-value list for the lower/upper multiplier
            values. Defaults to None. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/imshow.html#Contrast-stretching
        wh_ratio (float): Aspect ratio of the image (width/height). Defaults to 1.0. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/imshow.html#width-height-ratio
    Examples
    --------
    Basic:
...
def nq(df, **kwargs):
    ...
    Keyword Args:
        ...
        x (str): x-axis column name (if using a 1D dataset). Defaults to None. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/nq.html#1D-dataset
        CALCULATION:
        sigma (float): Maximum sigma value to use for the calculation; range will be +/- this value. Defaults to Auto-
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/nq.html#custom-sigma-range
        step_inner (float): Delta between sigma values outside of the tail (around sigma=0). Defaults to 0.5. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/nq.html#point-density
        step_tail (float): Delta between sigma values in the tails (all value >= and <= to keyword "tail"). Defaults to
            0.2. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/nq.html#point-density
        tail (float): Sigma value that represents the start of the tail of the distribution. Defaults to 3. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/nq.html#custom-tail
    Examples
    --------
    "Normal" distribution:
...
def pie(df, **kwargs):
    ...
    Keyword Args:
        ...
        pie_colors|colors (str|list): Wedge fill colors. Defaults to fcp.DEFAULT_COLORS. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/pie.html#colors
        pie_counter_clock|counter_clock (bool): Places wedges in a counter-clockwise fashion. Defaults to False.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/pie.html#counter-clockwise
        ...
        pie_edge_style|edge_style (str): Line style for the wedge edge lines {‘-’, ‘--’, ‘-.’, ‘:’}. Defaults to '-’.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/pie.html#colors
        ...
        pie_explode|explode (list of float): Emphasize one or more wedges by offsetting it from the center of the pie by
            some amount. Defaults to None. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/pie.html#explode
        ...
        pie_font_color|font_color (str): Font color for the wedge labels. Defaults to #444444. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/pie.html#wedge-labels
        ...
        pie_inner_radius|inner_radius (float): Distance from the center of the pie to the inner edge; used to make donut
            plots. Defaults to pie.html#donut.
        pie_label_distance|label_distance (float): Distance from the center of the pie to the category labels. Defaults
            to 1.1. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/pie.html#wedge-labels
        pie_percents_distance|percents_distance (float): Distance from center [0] to edge [pie_radius] at which
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/pie.html#labeled-percents
        pie_percents_font_color|percents_font_color (str): Font color for the percentage labels. Defaults to #444444.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/pie.html#labeled-percents
        ...
        pie_radius|radius (float): Sets the radius of the pie chart. Defaults to 1. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/pie.html#basic-plot
        ...
        pie_shadow|shadow (bool): Add a shadow to give a 3D appearance to the pie chart. Defaults to False. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/pie.html#shadow
        pie_start_angle|start_angle (float): The angle at which the first wedge starts with [3 o'clock = 0; 12 o'clock
            =90; etc]. Defaults to 90. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/pie.html#start-
            angle
    Examples
    --------
        >>> import fivecentplots as fcp
...
def plot(df, **kwargs):
    ...
    Keyword Args:
        ...
        line_color (str|list): Hex color string or list of hex color strings for the plot lines. Defaults to
            fcp.DEFAULT_COLORS. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Line-styling
        line_style (str|list): Matplotlib string character for line style {'-'; '--'; '-.' ':'}. Defaults to '-'.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Line-styling
        ...
        marker_edge_color (str|list): Hex color string for the marker edges. Defaults to fcp.DEFAULT_COLORS. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Marker-colors
        ...
        marker_fill_color (str|list): Hex color string for the fill color of markers. Defaults to fcp.DEFAULT_COLORS.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Marker-colors
        marker_jitter|jitter (boolean): For boxplots add random noise on x-axis to show separation between markers.
            Defaults to True. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/boxplot.html#Jitter
        marker_size (float|str): Size in pixels of the data point markers or a DataFrame column name with a custom
            marker size on each row. Defaults to 6. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Marker-size
        markers (boolean): Enable/disable data point markers. Defaults to True.
        AX_[H|V]LINES:
        [ax|ax2]_[h|v]lines (float|list of tuples and floats): Add horizontal / vertical lines to the plot; if only
            float value is provided add a solid black line with width=1 pixel at that value; if tuple add any one or
            more of the following in order: [1] float value or DataFrame column name [required]; [2] hex string for line
            color; [3] line style str; [4] line width in pixels; [5] line alpha transparency value from 0-1; [6] legend
            text  [added automatically if using a column name for value]. Defaults to None. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Horizontal-&-vertical-lines
        [ax|ax2]_[h|v]lines_alpha (float|list of floats): Transparency value for the lines between 0-1; use a list to
            use different values for each subplot. Defaults to 1.
        [ax|ax2]_[h|v]lines_by_plot (bool): Add a line with a different value to each subplot when using row/col/wrap
        ...
        control_limit_side (str): Determines if shaded region is <= lcl and >= ucl {"outside"} or between the lcl and
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Control-limits
        ...
        lcl|ucl_fill_alpha (float): Transparency value for the control limit shaded region fill between 0-1. Defaults to
            0.20. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Control-limits
        lcl|ucl_fill_color (str): Hex color string for the control limit shaded region fill. Defaults to
            fcp.DEFAULT_COLORS. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Control-limits
        ...
        conf_int (float): Interval with upper and lower bounds based on a single confidence value between 0-1
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Confidence-interval
        ...
        conf_int_|perc_int_|nq_int_edge_width (float): Width of the lines bounding the interval shaded region in pixels.
            Defaults to 1. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Confidence-interval
        conf_int_|perc_int_|nq_int_fill_alpha (float): Transparency value for the interval shaded region fill between
            0-1. Defaults to 0.20. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Confidence-
            interval
        conf_int_|perc_int_|nq_int_fill_color (str): Hex color string for the interval shaded region fill. Defaults to
            fcp.DEFAULT_COLORS. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Confidence-
            interval
        ...
        perc_int (list of float): Interval with upper and lower bounds based on percentiles between 0-1. Defaults to
            None. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Confidence-interval
        FIT:
        fit (int): Polynomial degree for the fit. Defaults to None. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Line-fit
        ...
        fit_range_x (list): Compute the fit only over a given range of x-values. Defaults to None. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Curve-fitting
        ...
        ref_line (list|pd.Series): The name of one or more columns in the DataFrame or a pandas Series with the same
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Reference-line
        ...
        ref_line_width (int|list): Reference line width in pixels (use list if more than one ref_line plotted). Defaults
            to 1. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Reference-line
        STAT_LINES:
        stat (str): Calculate a statistic on a data set (any stat value supported by pandas.groupby is valid {'mean',
            'std', etc}. Defaults to None. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Stat-
            lines
        ...
        stat_val (str): Alternate column name used as a pseudo x-axis for the stat calculation for cases in which the
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Stat-lines
    Examples
    --------
        >>> import fivecentplots as fcp
        >>> from pathlib import Path
...
def axes():
    ...
    Keyword Args:
        ...
        ax_edge_bottom (boolean): Enable/disable the bottom axes edge (or spine). Defaults to True. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Axes-edges
        ax_edge_color (str): Hex color string for the border edge of the axes region. Defaults to #aaaaaa. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Typical-elements
        ...
        ax_fill_alpha (str): Transparency value for axes fill between 0-1. Defaults to 1. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Alpha
        ...
        ax_scale|ax2_scale (str): Set the scale type of the axes {'linear'; 'logx'; 'semilogx'; 'logy'; 'semilogy';
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Log-scale
        ax_size (list of int | str): Axes size [width, height]; note this is not the size of the entire figure but just
            the axes area; for boxplots can enter 'auto' to auto-scale the width. Defaults to [400, 400]. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Time-series
        share_col (boolean): Share the x and y axis ranges of subplots in the same column when grouping. Defaults to
            True. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ranges.html#Share-columns
        share_row (boolean): Share the x and y axis ranges of subplots in the same row when grouping. Defaults to True.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ranges.html#Share-row
        share_x (boolean): Share the x-axis range across grouped plots with multiple axes. Defaults to True. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/ranges.html#Axes-sharing
        share_x2 (boolean): Share the secondary x-axis range across grouped plots with multiple axes. Defaults to True.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ranges.html#Axes-sharing
        ...
        twin_x (boolean): Add a secondary y-axis by "twinning" the x-axis. Defaults to False. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Shared-x-axis-(twin_x)
        twin_y (boolean): Add a secondary x-axis by "twinning" the y-axis. Defaults to False. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Shared-y-axis-(twin_y)
    Examples
    --------
        >>> import fivecentplots as fcp
        >>> from pathlib import Path
...
def gantt_today():
    """Dummy function to return the gantt_today API with `help()` (not used directly for plotting).

    Keyword Args:
        gantt_today (boolean): Enable/disable Gantt today line plotting. Defaults to False. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/gantt.html#Gantt-today
        gantt_today_date (datetime): Date of the today line. Defaults to datetime.datetime.now(). Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/gantt.html#Gantt-today
        gantt_today_color (str): Hex color string for the today line. Defaults to #ff0000. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/gantt.html#Gantt-today
        gantt_today_width (float): Width of the today line in pixels (float ok). Defaults to 1.3. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/gantt.html#Gantt-today
    """


def gantt_workstreams():
    """Dummy function to return the gantt_workstreams API with `help()` (not used directly for plotting).

    Keyword Args:
        gantt_workstreams (boolean): Enable/disable Gantt workstream plotting. Defaults to False. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/gantt.html#Gantt-workstreams
        gantt_workstreams_location (str): Location of the workstream plot {'inline'; 'separate'}. Defaults to
            'separate'. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/gantt.html#Gantt-workstreams
        gantt_workstreams_title (str): Title of the workstream plot. Defaults to 'Workstreams'. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/gantt.html#Gantt-workstreams
    """
...
def gridlines():
    ...
    Keyword Args:
        grid_major (boolean): Enable/disable major x-axis and y-axis gridlines. Defaults to True. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Grids
        ...
        grid_major_color (str): Hex-axis color string for x-axis and y-axis major gridlines. Defaults to #ffffff.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Grids
        ...
        grid_major_x2_alpha (str): Transparency value for secondary-axis major x-axis gridlines between 0-1. Defaults to
            1. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Grids
        ...
        grid_minor_y_width (float): Minor y-axis gridline width in pixels (float ok). Defaults to 0.5. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Grids
        tick_cleanup (str|boolean): Set the tick cleanup style when dealing with overlaping tick labels {False -> ignore
            | "shrink" -> change the font | "remove" -> delete one of the overlapping labels}. Defaults to shrink.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-cleanup
    Examples
    --------
        >>> import fivecentplots as fcp
        >>> from pathlib import Path
...
def grouping():
    ...
    Keyword Args:
        ...
        groups (str): for xy plot = name of DataFrame column that can be used to separate the data into unique groups so
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/grouping.html#xy-plots
        groups (str|list): for boxplot = name or list of names of DataFrame column(s) used to split the data into
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/grouping.html#boxplots
...
def labels():
    ...
    Keyword Args:
        AXES_LABELS:
        label_padding (float): Percent padding around the label text for the background object behind the text. Defaults
            to 2.
        label_q (str): Custom text for a specific axes label [where q = x, y, x2, y2]. Defaults to DataFrame column
            name. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Multiple-y-only
        label_q_edge_alpha (float): Transparency value for the label edge between 0-1 [where q = x, y, x2, y2]. Defaults
            to 1. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Edge-colors
        label_q_edge_color (str): Hex color string for the label edge [where q = x, y, x2, y2]. Defaults to #ffffff.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Edge-colors
        label_q_edge_width (float): Width of the border edge of a label in pixels [where q = x, y, x2, y2]. Defaults to
            1. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Edge-colors
        label_q_fill_alpha (float): Transparency value for the label background fill between 0-1 [where q = x, y, x2,
            y2]. Defaults to 1. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Fill-colors
        label_q_fill_color (str): Hex color string for the label edge [where q = x, y, x2, y2]. Defaults to #ffffff.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Fill-colors
        label_q_font (str): Font for a specific axes label [where q = x, y, x2, y2]. Defaults to sans-serif. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Fonts
        label_q_font_color (str): Hex color string for font color of a specific axes label [where q = x, y, x2, y2].
            Defaults to #000000. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Fonts
        ...
        label_q_font_style (str): Font style {'normal'|'italic'|'oblique'} for a specific axes label [where q = x, y,
            x2, y2]. Defaults to italic. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Fonts
        ...
        label_q_edge_alpha (float): Transparency value for the label edge between 0-1 [where q = rc, col, row, wrap; rc
            changes all]. Defaults to 1. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Edge-
            colors
        label_q_edge_color (str): Hex color string for the label edge [where q = rc, col, row, wrap; rc changes all].
            Defaults to #8c8c8c. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Edge-colors
        label_q_edge_width (float): Width of the border edge of a label in pixels [where q = rc, col, row, wrap; rc
            changes all]. Defaults to 0. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Edge-
            colors
        label_q_fill_alpha (float): Transparency value for the label background fill between 0-1 [where q = rc, col,
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Fill-colors
        label_q_fill_color (str): Hex color string for the label edge [where q = rc, col, row, wrap; rc changes all].
            Defaults to #8c8c8c. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Fill-colors
        label_q_font (str): Font for a specific axes label [where q = rc, col, row, wrap; rc changes all]. Defaults to
            sans-serif. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Fonts
        ...
        label_q_font_size (str): Font size for a specific axes label [where q = rc, col, row, wrap; rc changes all].
            Defaults to 16. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Fonts
        ...
        label_q_names (boolean): Toggle including the DataFrame column names in the row or column labels [where q = rc,
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/plot.html#Column-plot
        ...
        title_wrap_edge_alpha (float): Transparency value for the wrap title bar edge between 0-1. Defaults to
            label_rc_. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Edge-colors
        ...
        title_wrap_fill_alpha (float): Transparency value for the wrap title bar background fill between 0-1. Defaults
            to label_wrap_fill_alpha. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Fill-
            colors
...
def legend():
    ...
    Keyword Args:
        ...
        legend_location (int): Position of the legend {0 = outside; 1 = upper right; 2 = upper left; 3 = lower left; 4 =
            lower right; 5 = right; 6 = center left; 7 = center right; 8 = lower center; 9 = upper center; 10 = center;
            11 = below}. Defaults to  0. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/grouping.html#Location
...
def options():
    ...
    Keyword Args:
        ...
        DEFAULT_COLORS (list): Default color scheme used for lines and markers (from colors.py); alias COLORS also can
            be used for brevity. Defaults to None.
        HIST (dict): Shortcut of useful kwargs to format hist plots {'ax_scale': 'logy', 'markers': False, 'line_width':
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/hist.html#fcp.HIST
        RCCG (list): Color scheme for Bayer RCCG channel data so lines and markers match CFA type. Defaults to None.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/hist.html#RGB
        RGB (list): Color scheme for Bayer RGB channel data so lines and markers match color channnels. Defaults to
            None. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/hist.html#RGB
        RGGB (list): Color scheme for Bayer RGGB channel data so lines and markers match CFA type. Defaults to None.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/hist.html#RGB
        engine (str): Specify the plotting engine {'mpl', 'bokeh'}. Defaults to 'mpl'. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/layout.html#engine
        filename (str): Name of the saved image (with or without path and/or extension). Defaults to Automatic name
            ...
            https://endangeredoxen.github.io/fivecentplots/0.6.2/grouping.html#figure-plots
        ...
        hold (bool): For interactive plotting with matplotlib, keeps the previous plots enabled when creating a new plot
            with fcp; otherwise, previous plots are closed with each new fcp plot. Defaults to False.
        ...
        show (str): Show the "saved" plot image file using the default image viewer of the host PC.  Setting as "True"
...
def tick_labels():
    ...
    Keyword Args:
        ...
        sci_[x|x2|y|y2|z] (bool): Enable/disable scientific notation for tick labels. Defaults to False.
        tick_labels (boolean): Enable/disable all tick labels. Defaults to True.
        tick_labels_[major|minor] (boolean): Enable/disable all major tick labels. Defaults to True.
        tick_labels_[major|minor]_edge_alpha (float): Transparency value for all major tick labels background edges
            between 0-1. Defaults to 0.
        tick_labels_[major|minor]_edge_color (str): Hex color string for all major tick label background edges. Defaults
            to #ffffff.
        tick_labels_[major|minor]_edge_width (float): Width of the border edge of all major tick labels in pixels.
            Defaults to 0.
        tick_labels_[major|minor]_fill_alpha (float): Transparency value for the background fill of all major tick
            labels between 0-1. Defaults to 1.
        tick_labels_[major|minor]_fill_color (str): Hex color string for all major tick label background edges. Defaults
            to #ffffff.
        tick_labels_[major|minor]_font (str): Font for all major tick labels. Defaults to sans-serif.
        tick_labels_[major|minor]_font_color (str): Hex color string for font color of all major tick labels. Defaults
            to #000000.
        tick_labels_[major|minor]_font_size (str): Font size for all major tick labels. Defaults to 13.
        tick_labels_[major|minor]_font_style (str): Font style {'normal'|'italic'|'oblique'} for all major tick labels.
            Defaults to normal.
        tick_labels_[major|minor]_font_weight (str): Font weight
            {'normal'|'bold'|'heavy'|'light'|'ultrabold'|'ultralight'} of all major tick labels. Defaults to normal.
        tick_labels_[major|minor]_q (boolean): Enable/disable major tick labels of a specific axes [where q = x, y, x2,
            y2]. Defaults to True.
        tick_labels_[major|minor]_q_edge_alpha (float): Transparency value for major tick labels background edges of a
            specific axes between 0-1 [where q = x, y, x2, y2]. Defaults to 0.
        tick_labels_[major|minor]_q_edge_color (str): Hex color string for major tick label background edges of a
            specific axis [where q = x, y, x2, y2]. Defaults to #ffffff.
        tick_labels_[major|minor]_q_edge_width (float): Width of the border edge of all major tick labels of a specific
            axis in pixels [where q = x, y, x2, y2]. Defaults to 0.
        tick_labels_[major|minor]_q_fill_alpha (float): Transparency value for the background fill of all major tick
            labels of a specific axis between 0-1 [where q = x, y, x2, y2]. Defaults to 1.
        tick_labels_[major|minor]_q_fill_color (str): Hex color string for major tick label background edges of a
            specific axis [where q = x, y, x2, y2]. Defaults to #ffffff.
        tick_labels_[major|minor]_q_font (str): Font for major tick labels of a specific axes [where q = x, y, x2, y2].
            Defaults to sans-serif.
        tick_labels_[major|minor]_q_font_color (str): Hex color string for font color of major tick labels of a specific
            axes [where q = x, y, x2, y2]. Defaults to #000000.
        tick_labels_[major|minor]_q_font_size (str): Font size for major tick labels of a specific axes label [where q =
            x, y, x2, y2]. Defaults to 13.
        tick_labels_[major|minor]_q_font_style (str): Font style {'normal'|'italic'|'oblique'} for major tick labels of
            a specific axes [where q = x, y, x2, y2]. Defaults to normal.
        tick_labels_[major|minor]_q_font_weight (str): Font weight
            {'normal'|'bold'|'heavy'|'light'|'ultrabold'|'ultralight'} of major tick labels of a specific axes [where q
            = x, y, x2, y2]. Defaults to normal.
        tick_labels_edge_alpha (float): Transparency value for all tick labels background edges between 0-1. Defaults to
            0.
        tick_labels_edge_color (str): Hex color string for all tick label background edges. Defaults to #ffffff.
        tick_labels_edge_width (float): Width of the border edge of all tick labels in pixels. Defaults to 0.
...
def ticks():
    ...
    Keyword Args:
        ticks_major (boolean): Enable/disable major x-axis and y-axis tick marks. Defaults to True. Example:
          https://endangeredoxen.github.io/fivecentplots/0.6.0/ticks.html#Tick-marks
        ...
        ticks_major_color (str): Hex-axis color string for x-axis and y-axis major tick marks. Defaults to #ffffff.
          Example: https://endangeredoxen.github.io/fivecentplots/0.6.0/ticks.html#Tick-marks
        ticks_major_direction (str): Point tick marks 'in' or 'out' from the axes area. Defaults to 'in'. Example:
          https://endangeredoxen.github.io/fivecentplots/0.6.0/ticks.html#Tick-style
        ticks_major_increment (float): Specify the spacing of major tick marks. Defaults to None. Example:
          https://endangeredoxen.github.io/fivecentplots/0.6.0/ticks.html#Tick-increment
        ...
        ticks_major_x2_alpha (str): Transparency-axis value for secondary-axis major x-axis tick marks between 0-1.
          Defaults to 1. Example: https://endangeredoxen.github.io/fivecentplots/0.6.0/ticks.html#Tick-marks
        ticks_major_x2_color (str): Hex-axis color string for secondary-axis x-axis major tick marks. Defaults to
          #ffffff. Example: https://endangeredoxen.github.io/fivecentplots/0.6.0/ticks.html#Tick-marks
        ...
        ticks_minor_length (float): Specify the length of the minor tick marks in pixels. Defaults to 0.67 *
          ticks_major_length. Example: https://endangeredoxen.github.io/fivecentplots/0.6.0/ticks.html#Tick-style
        ...
        ticks_minor_width (float): Specify the width of the minor tick marks in pixels. Defaults to 0.6 *
          ticks_major_width. Example: https://endangeredoxen.github.io/fivecentplots/0.6.0/ticks.html#Tick-style
        ...
        ticks_minor_y_width (float): minor y-axis tickline width in pixels (float ok). Defaults to 0.5. Example:
          https://endangeredoxen.github.io/fivecentplots/0.6.0/ticks.html#Tick-marks
        auto_tick_threshold (list[float]): Threshold levels to determine if ticks should use scientific notation.
            Defaults to [1e-6,1e6].
        ticks_[major|minor] (boolean): Enable/disable major or minor tick marks; if no axis label is provided, setting
            is applied to all axes. Defaults to True. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-marks
        ticks_[major|minor]_[x|x2|y|y2|z] (boolean): Enable/disable major or minor tick marks for a specific axis.
            Defaults to True. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-marks
        ticks_[major|minor]_[x|x2|y|y2|z]_alpha (str): Transparency-axis value for major or minor tick lines between 0-1
            for a specific axis. Defaults to 1. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-marks
        ticks_[major|minor]_[x|x2|y|y2|z]_color (str): Hex-axis color string for x-axis major or minor tick marks for a
            specific axis. Defaults to #ffffff. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-marks
        ticks_[major|minor]_[x|x2|y|y2|z]_direction (str): Point tick marks 'in' or 'out' from the axes area for a
            specific axis. Defaults to 'in'. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-style
        ticks_[major|minor]_[x|x2|y|y2|z]_increment (float): Specify the spacing of major or minor tick marks for a
            specific axis. Defaults to None. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-increment
        ticks_[major|minor]_[x|x2|y|y2|z]_length (float): Specify the length of the major or minor tick marks in pixels
            for a specific axis. Defaults to 6.2. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-style
        ticks_[major|minor]_[x|x2|y|y2|z]_width (float): Specify the width of the major or minor tick marks in pixels
            for a specific axis. Defaults to 2.2. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-style
        ticks_[major|minor]_[x|x2|y|y2|z]_width (float): major or minor x-axis tickline width in pixels for a specific
            axis (float ok). Defaults to 1.3. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-marks
        ticks_[major|minor]_alpha (str): Transparency-axis value for major or minor tick marks between 0-1 for all axes.
            Defaults to 1. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-marks
        ticks_[major|minor]_color (str): Hex-axis color string for x-axis and y-axis major or minor tick marks for all
            axes. Defaults to #ffffff. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-
            marks
        ticks_[major|minor]_direction (str): Point tick marks 'in' or 'out' from the axes area for all axes. Defaults to
            'in'. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-style
        ticks_[major|minor]_increment (float): Specify the spacing of major or minor tick marks for all axes. Defaults
            to None. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-increment
        ticks_[major|minor]_length (float): Specify the length of the major or minor tick marks in pixels for all axes.
            Defaults to 6.2. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-style
        ticks_[major|minor]_width (float): major or minor tickline width in pixels for all axes (float ok). Defaults to
            1.3. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-marks
        ticks_[major|minor]_width (float): Specify the width of the major or minor tick marks in pixels for all axes.
            Defaults to 2.2. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-style
        ticks_[x|x2|y|y2|z] (boolean): Enable/disable major and minor tick marks for a specific axis. Defaults to True.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-marks
        ticks_[x|x2|y|y2|z]_alpha (str): Transparency-axis value for major and minor tick lines between 0-1 for a
            specific axis. Defaults to 1. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-
            marks
        ticks_[x|x2|y|y2|z]_color (str): Hex-axis color string for x-axis major and minor tick marks for a specific
            axis. Defaults to #ffffff. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-
            marks
        ticks_[x|x2|y|y2|z]_direction (str): Point major and minor tick marks 'in' or 'out' from the axes area for a
            specific axis. Defaults to 'in'. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-style
        ticks_[x|x2|y|y2|z]_increment (float): Specify the major and minor spacing of major or minor tick marks for a
            specific axis. Defaults to None. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-increment
        ticks_[x|x2|y|y2|z]_length (float): Specify the length of the major and minor tick marks in pixels for a
            specific axis. Defaults to 6.2. Example:
            https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-style
        ticks_[x|x2|y|y2|z]_width (float): Major and minor x-axis tickline width in pixels for a specific axis (float
            ok). Defaults to 1.3. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-marks
        ticks_[x|x2|y|y2|z]_width (float): Specify the width of the major and minor tick marks in pixels for a specific
            axis. Defaults to 2.2. Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/ticks.html#Tick-style
    Examples
    --------
    Default styling:
...
def titles():
    ...
    Keyword Args:
        ...
        title_font_style (str): Font style {'normal'|'italic'|'oblique'} for the figure title. Defaults to italic.
            Example: https://endangeredoxen.github.io/fivecentplots/0.6.2/styles.html#Fonts
        title_font_weight (str): Font weight {a numeric value in range 0-1000|'ultralight'|'light'|'normal'|'regular'|'b
            ook'|'medium'|'roman'|'semibold'|'demibold'|'demi'|'bold'|'heavy'|'extra bold'|'black'} for the figure
            title. Defaults to bold.
    Examples
    --------
        >>> import fivecentplots as fcp
        >>> from pathlib import Path

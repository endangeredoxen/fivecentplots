...
fcp_params = {'ax_edge_color'         : '#555555',
              ...
              'bp_boxes_fill_color'   : '#eeeeee',
              'bp_label_size'         : 25,
              'bp_item_label_edge_color'   : '#555555',
              'bp_item_label_fill_color'   : '#eeeeee',
              'bp_item_label_font_size'    : 13,
              'bp_item_label_font_color'   : '#666666',
              'bp_item_label_font_style'   : 'normal',
              'bp_item_label_font_weight'  : 'normal',
              'bp_group_label_font_size'     : 12,
              'bp_group_label_font_color'    : '#666666',
              'bp_group_label_font_style'    : 'normal',
              'bp_group_label_font_weight'   : 'normal',
              'cbar_text_width'       : 45,
              'cbar_width'            : 30,
              'cmap'                  : 'inferno',
              'cols'                  : 1,
              ...
              'grid_major_line_width' : 1,
              'grid_minor_color'      : '#eeeeee',
              'grid_minor_line_style' : 'dotted',
              'grid_minor_line_width' : 0.4,
              'inline'                : False,
              'label_color'           : 'k',
              'label_font_size'       : 14,
              'label_style'           : 'italic',
              ...
              'marker_size'           : 7,
              'marker_type'           : 'o',
              'rc_label_edge_color'   : '#ffffff',
              'rc_label_fill_color'   : '#888888',
              ...
              'rc_label_size'         : 30,
              'rows'                  : 1,
              'tick_color_major'      : '#555555',
              'tick_color_minor'      : '#999999',
              'tick_font_size'        : 12,
              ...
              'wrap_title_edge_color' : '#ffffff',
              'wrap_title_fill_color' : '#888888', #'#969ab3',
              'wrap_title_font_size'  : 16,
              'wrap_title_text_color' : '#ffffff',
              'wrap_title_text_style' : 'normal',
              'wrap_title_text_weight': 'bold',
              'wrap_title_size'       : 30,
              'ws_bp_name'            : 3,
              'ws_cbar_ax'            : 10,
              'ws_col'                : 30,

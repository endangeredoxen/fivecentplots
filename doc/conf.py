...
# -*- coding: utf-8 -*-
#
# fivecentplots documentation build configuration file, created by
...
htmlhelp_basename = 'fivecentplotsdoc'
...
latex_documents = [
  (master_doc, 'fivecentplots.tex', 'fivecentplots Documentation',
   'Steve Nicholes', 'manual'),
]
...
man_pages = [
    (master_doc, 'fivecentplots', 'fivecentplots Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'fivecentplots', 'fivecentplots Documentation',
   author, 'fivecentplots', 'One line description of project.',
   'Miscellaneous'),
]
